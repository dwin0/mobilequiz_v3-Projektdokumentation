...
Am Ende der Arbeit wurden die gleichen Tests nochmals durchgeführt. Es nahmen dabei .... \todo{Studenten + Studienrichtung notieren} teil. Aus dieser Durchführung wurden die Auswertungen ebenfalls niedergeschrieben (siehe Usability-Test\_Auswertung\_Durchführung2).

Die erwähnten Dokumente befinden sich im Anhang.

\todo{In Anhang hinzufügen und Verweis erstellen}
...
Aus den Erkenntnissen der \gls{Usability-Tests} sowie den eigenen Tests mit dem MobileQuiz wurden die ersten \gls{Wireframes} erstellt, diese befinden sich im Anhang. \todo{Wireframes in den Anhang und Verweis}

\subsection{Erkenntnisse am Ende der Arbeit} \todo{ausformulieren mit Resultaten}
...
\todo{Erkenntnisse in Abschnitt arbeit für nächste sa ba}
...
\todo{CodeClimate Disabled Checks oder config-file einfügen}
\todo{Codestatistik Schlusstand heraussuchen und kommentieren}
...
\todo{Continuous Integration mit Travis}
