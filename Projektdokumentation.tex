...
\begin{document}
	...
	\input{InhalteFuerFolgearbeiten.tex}
	...
	\includepdf[pages={1}, pagecommand={\label{pdf:eigeneTests}}]{PDFs/Ergebnisse_eigene_Tests.pdf}
	\includepdf[pages={2-5}, pagecommand={}]{PDFs/Ergebnisse_eigene_Tests.pdf}
	\includepdf[pages={1}, landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:webauswertungMatrix}}]{PDFs/WebauswertungMatrix.pdf}
	\includepdf[pages={2-3}, landscape=true, pagecommand=\thispagestyle{mylandscape}]{PDFs/WebauswertungMatrix.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:UTAS1}}]{PDFs/Usability-Test_Aufgabenstellung.pdf}
	\includepdf[pages={2}, pagecommand={}]{PDFs/Usability-Test_Aufgabenstellung.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:UTAW1}}]{PDFs/Usability-Test_Auswertung.pdf}
	\includepdf[pages={2-8}, pagecommand={}]{PDFs/Usability-Test_Auswertung.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:UTAS2}}]{PDFs/Usability-Test-2_Aufgabenstellung.pdf}
	\includepdf[pages={2}, pagecommand={}]{PDFs/Usability-Test-2_Aufgabenstellung.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:UTAW2}}]{PDFs/Usability-Test2_Auswertung.pdf}
	\includepdf[pages={2-5}, pagecommand={}]{PDFs/Usability-Test2_Auswertung.pdf}
	\includepdf[landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:dbVorVeraenderung}}]{PDFs/DB_vorVeraenderungen.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:defaultEinstellungen}}]{PDFs/defaultEinstellungen.pdf}
	\includepdf[pages={2}, pagecommand={}]{PDFs/defaultEinstellungen.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:gruppenadmin}}]{PDFs/Gruppenadministration.pdf}
	\includepdf[pages={2-6}, pagecommand={}]{PDFs/Gruppenadministration.pdf}
	\includepdf[landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:dbgruppenadmin}}]{PDFs/Gruppenadministration_DB.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:konzeptFragen}}]{PDFs/Neue_Fragetypen.pdf}
	\includepdf[pages={2-15}, pagecommand={}]{PDFs/Neue_Fragetypen.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:konzeptStatistiken}}]{PDFs/Statistiken_Auswertungen.pdf}
	\includepdf[pages={2-13}, pagecommand={}]{PDFs/Statistiken_Auswertungen.pdf}
	\includepdf[pages={1}, landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:moeglicheArbeiten}}]{PDFs/MoeglicheArbeitenSA.pdf}
	\includepdf[pages={2-3}, landscape=true, pagecommand=\thispagestyle{mylandscape}]{PDFs/MoeglicheArbeitenSA.pdf}
	\includepdf[landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:csvTemplate}}]{PDFs/CSV_Template.pdf}
	\includepdf[landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:socrative}}]{PDFs/socrativeQuizTemplate.pdf}
	\includepdf[landscape=true, pagecommand=\thispagestyle{mylandscape}{\label{pdf:excelTemplate}}]{PDFs/Excel-Frage-Template.pdf}
	\includepdf[pages={1}, pagecommand={\label{pdf:recherchetipps}}]{PDFs/Recherchetipps_book-a-librarian.pdf}
	\includepdf[pages={2-3}, pagecommand={}]{PDFs/Recherchetipps_book-a-librarian.pdf}
	...
	\includepdf[pages={1-19}, landscape=true, pagecommand=\thispagestyle{mylandscape}]{PDFs/MockupsVersion2.pdf}
	...
	\input{AnfaenglicheCodeAenderungen.tex}
	
	\newpage
	\section{Änderungen am Server}
	\label{sec:AenderungenAmServer}
	\input{AenderungenAmServer.tex}
	...
	\includepdf[landscape=true, pagecommand=\thispagestyle{mylandscape}]{PDFs/TechnischeRisiken.pdf} 
