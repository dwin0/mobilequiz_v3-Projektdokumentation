...
\begin{document}
	...
	\chapter{Abstract} \todo{Abstract schreiben}
	...
	\begin{tabularx}{\linewidth}{|c|X|c|c|}
		...
		\hline
		1.14 & Kapitel 3 Aufgabenstellung erstellt & dwi & 17.12.2016 \\
		\hline
	\end{tabularx}
	...
	\chapter{Erklärung zur Urheberschaft} \todo{Erklärung der Urheberschaft Formular HSR}
	...
	%Mobile Quiz Prototype 1.0
	%Khalid Abdul, Patrik Naef
	%Bachelorarbeit «Mobile Quiz - Web-Anwendung für Lernkontrollen»
	%MobileQuiz.ch Release 2.0
	%Pascal Artho
	%Redesign/Erweiterung der Mobile Quiz Anwendung
	%MobileQuiz.ch Release 3.0
	%Patrick Eichler
	%Redesign/Erweiterung der Mobile Quiz Anwendung
	...
	\todo{vereinbarung zur weiterverwendung}
	...
	\chapter{Design}
	\todo{Beschreibung von einzelnen, wichtigen Mockups und diese in den Anhang}
	...
	\includepdf[pages={1-3}, landscape=true]{PDFs/MoeglicheArbeitenSA.pdf}
	\label{pdf:MoeglicheArbeitenSA}
