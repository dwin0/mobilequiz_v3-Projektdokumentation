...
Die Ergebnisse aus dieser Untersuchung flossen zusammen mit den bereits bekannten Verbesserungspunkten \todo{In den Anhang und verweis darauf: Offene Punkte MobileQuiz.docx und Verbesserungen Mobilequiz v3.docx} in die Aufgabenstellung dieser Studienarbeit ein und sind im Anhang unter 'MoeglicheArbeitenSA.pdf' \ref{pdf:MoeglicheArbeitenSA} \todo{Verweis auf Anhang} ersichtlich. Um nicht jeden Bug einzeln aufzuführen, wurden darin die Probleme abstrahiert und nur Themenbereiche aufgeführt und beschrieben. Diese wurden zusammen mit dem Betreuer nach ihrer Wichtigkeit priorisiert.
...
\todo{was wurde mit arbeiten gemacht?}
Von den gefundenen Arbeiten konnte keine für die Lösung von spezifischen Fragestellungen als Nachschlagwerk verwendet werden. Die Arbeiten, welche von Prod. Dr. Peter Heinzmann betreut wurden, waren schon in Mobile Quiz integriert, andere Arbeiten wiesen einen anderen Einsatzzweck auf.
...
Was kann Mobile Quiz heute bereits, wo gibt es noch Probleme und wo steht das Quiz heute im Vergleich zu ähnlichen Webanwendungen? Diese Fragen waren Kern der eigenen Untersuchungen. Einerseits wurde dazu Mobile Quiz selbst intensiv getestet, andererseits wurden mehrere vergleichbare Online-Quizzes gesucht und diese anhand von vorher definierten Kriterien verglichen.
	...
	\begin{itemize}
		...
		\todo{Referenzen von Bildern angeben}
		\begin{figure}[H]
			\centering
	...
	\todo{Anhang einfügen und Verweis auf Anhang}
	


	\subsection{Vergleich Online-Quizzes}
	\label{subsec:Webuntersuchungen}
	Um andere Online-Quizzes mit Mobile Quiz zu vergleichen mussten zuerst die Kriterien festgelegt werden. Als Grundlage diente eine Excel-Tabelle von Khalid Abdul und Patrik Naef \todo{Verweis auf BA}, welche an die Bedürfnisse dieser Arbeit angepasst wurde. Es wurden folgende Vergleichskriterien festgelegt:
	\begin{itemize}
	...
	\begin{itemize}
		...
		Bei Mobile Quiz wurde der Ablauf der Quiz-Erstellung neu organisiert und in diesem Schritt auch die Quiz-Einstellungen verteilter und übersichtlicher angeordnet. Die genaue Beschreibung ist in Kapitel 13 vorzufinden. \todo{Referenz einfügen}
		...
		Socrative \cite{socrative.com} an. Es ist im Anhang unter 'socrativeQuizTemplate.xlsx' zu finden. \todo{pdf in anhang und verweis erstellen}
