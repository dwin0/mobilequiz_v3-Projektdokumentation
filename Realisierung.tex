...
\newglossaryentry{XML External Entitiy} {name={XML External Entitiy-Attacke},description={}}  \todo{Erklären}
...
\todo{Beschreibung der Angabe des Interessen-Gebietes sowie multiselect-filter}
%Der Teilnehmer soll angeben können, für welche Fächer/Interessen er sich im Mobile Quiz anmeldet. Anschliessend soll der Filter nach den angegebenen Kriterien gesetzt werden. Die Möglichkeit alles anzeigen zu lassen, bleibt bestehen.

	
\todo{Frage-Erstellung beschreiben / Quiz-Erstellung mit Durchführung und DB-Änderung beschreiben. Wichtig: Vorteile und Gründe aufzeigen}
%Wird eine Lernkontrolle einer Gruppe zugeordnet, so soll ein Enddatum nur für diese Gruppe festgelegt werden können. Dies wird beispielsweise in CN1 benötigt, bei dem die eine Gruppe1 das Praktikum 1 Woche früher besucht als Gruppe2.

\todo{Beschreibung der Default-Einstellungen für Lernhilfe, etc.}
\todo{Beschreien: Person kann neu mehr als 1 Gruppe zugewiesen werden}
...
\todo{Andrea} %Umformulieren und korrekten Ordner angeben, wenn Struktur für Schlussabgabe erstellt wurde
...
%TODO: Geschwindigkeiten gemäss hei verwenden
\begin{tabular}{|c|c|c|}
	\hline 
